...
main = do
    assert (sumHeights2 [5,3,6,7,2] 2 4 == 7) (putStrLn "Test passed")
    assert (sumHeights2 [5,3,6,7,2] 0 1 == 2) (putStrLn "Test passed")
    assert (sumHeights2 [5,3,6,7,2] 0 4 == 15) (putStrLn "Test passed")
    assert (sumHeights2 [5,3,6,7,2] 2 4 == 7) (putStrLn "Test passed")
    assert (sumHeights2 [5,3,6,7,2] 0 1 == 2) (putStrLn "Test passed")
    assert (sumHeights2 [5,3,6,7,2] 0 4 == 15) (putStrLn "Test passed")
